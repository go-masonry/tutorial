...
type SubWorkshopValidations interface {
	PaintCar(ctx context.Context, request *api.SubPaintCarRequest) error
}
...
func (s subWorkshopValidations) PaintCar(ctx context.Context, request *api.SubPaintCarRequest) error {
